...
const IncompleteProfiles = () => {
  ...
  const openModal = (profile) => {
    ...
    setProfileData({ ...profile }); // Load existing profile data
    setPreviewImage(profile.profilePic); // Load profile picture if available
  };
            ...
            <form onSubmit={handleCompleteProfile}>
              ...
              {selectedProfile.type === "Labourer" && (
                <>
                  <div className="form-group">
                    <label>Skills:</label>
                    <input type="text" name="skills" value={profileData.skills} onChange={handleChange} required/>
                  </div>

                  <div className="form-group">
                    <label>Work Experience:</label>
                    <input type="text" name="workExperience" value={profileData.workExperience} onChange={handleChange} required/>
                  </div>
                </>
              )}
